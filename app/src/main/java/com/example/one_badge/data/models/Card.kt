...
fun CardData.toTeamCard(): TeamCard = when (this) {
    is CardData.TeamInfo -> TeamCard(
        id = 1L,
        title = "Team Info",
    ...
    is CardData.Description -> TeamCard(
        id = 2L,
        title = "Description",
        subtitle = data.teamName,
    ...
    is CardData.SocialMedia -> TeamCard(
        id = 4L,
        title = "Social Media",
        subtitle = data.teamName,
        details = buildString {
